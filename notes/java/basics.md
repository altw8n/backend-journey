...
|-----|--------|-------------------|
| `byte` | 1 байт (8 bit) | -128 ... 127 |
| `short` | 2 байта (16 bit) | -32,768 ... 32,767 |
| `int` | 4 байта (32 bit) | -2 млрд ... 2 млрд |
| `long` | 8 байт (64 bit) | Огромный диапазон (требует `L` на конце) |
| `float` | 4 байта | Дробные числа (требует `f` на конце) |
| `double` | 8 байт | Дробные числа высокой точности |
| `boolean` | 1 бит | `true` / `false` |
| `char` | 2 байта | 0 ... 65,535 (один символ Unicode) |
